...
struct ES_MatchingSchema_Ensamble
{
	...
	ES_MatchingSchema_Ensamble() :
			costValue(0.0), sigma1l(0), sigma2l(0), sigma1(NULL), sigma2(NULL)
	{}

    ES_MatchingSchema_Ensamble(const std::vector<unsigned>&_sigma_1, const std::vector<unsigned>&_sigma_2) :
			costValue(0.0), sigma1l(_sigma_1.size()), sigma2l(_sigma_2.size())
	{
